...
It was written against an imagined library, so none of its 37 theorem
statements has ever been checked and none of its 20 `sorry`s has ever
...
Kept, not deleted. Making it real means rewriting 825 lines against the
