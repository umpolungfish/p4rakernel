...
axiom ns_certificate : NavierStokesRegularity
...
axiom leray_weak_existence (u₀ : NSInitialDatum) : Nonempty (LerayWeakSolution u₀)
...
axiom ns_small_data_global_regularity (u₀ : NSInitialDatum) (_ : initialCriticalNorm u₀ < 1 / (2 * Real.sqrt 3)) : GlobalRegularityCert u₀
