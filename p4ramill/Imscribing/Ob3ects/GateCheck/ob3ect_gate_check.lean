-- IGProtocol scaffold: VINIT → FSPLIT → EVALF → AREV → ENGAGR → EVALT → AFWD → CLINK → IMSCRIB → FFUSE → IFIX → TANCH
...
noncomputable def ob3ect_sequence_protocol : IGProtocol ob3ect_sequence_s0 ob3ect_sequence_s11 :=
  ...
  -- Dual-Link self-pairing: .prod arms fuse via tensorProduct ob3ect_sequence_s9 ob3ect_sequence_s9 = ob3ect_sequence_s9 (idempotent)
  (.seq (.arrow ob3ect_sequence_l0 ob3ect_sequence_s0 ob3ect_sequence_s1) (.seq (.prod (.arrow ob3ect_sequence_l1 ob3ect_sequence_s1 ob3ect_sequence_s9) (.arrow ob3ect_sequence_l1 ob3ect_sequence_s1 ob3ect_sequence_s9)) (.seq (.arrow ob3ect_sequence_l9 ob3ect_sequence_s9 ob3ect_sequence_s9) (.seq (.arrow ob3ect_sequence_l9 ob3ect_sequence_s9 ob3ect_sequence_s10) (.arrow ob3ect_sequence_l10 ob3ect_sequence_s10 ob3ect_sequence_s11)))))
