...
-- Class: self_verifying_proof_assistant_structural_sibling_of_the_stone
...
noncomputable def self_verifying_proof_assistant_structural_sibling_of_the_stone_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def self_verifying_proof_assistant_structural_sibling_of_the_stone_true_arm : IGProtocol 𐑼 𐑡 :=
  (self_verifying_proof_assistant_structural_sibling_of_the_stone_protocol).restrictToEVALT
  --
-- false arm
noncomputable def self_verifying_proof_assistant_structural_sibling_of_the_stone_false_arm : IGProtocol 𐑼 𐑡 :=
  (self_verifying_proof_assistant_structural_sibling_of_the_stone_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem self_verifying_proof_assistant_structural_sibling_of_the_stone_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
