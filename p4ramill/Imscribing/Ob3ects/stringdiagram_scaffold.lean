...
noncomputable def stringdiagram_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def stringdiagram_true_arm : IGProtocol 𐑼 𐑡 :=
  (stringdiagram_protocol).restrictToEVALT
  --
-- false arm
noncomputable def stringdiagram_false_arm : IGProtocol 𐑼 𐑡 :=
  (stringdiagram_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem stringdiagram_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
