...
noncomputable def topos_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def topos_true_arm : IGProtocol 𐑼 𐑡 :=
  (topos_protocol).restrictToEVALT
  --
-- false arm
noncomputable def topos_false_arm : IGProtocol 𐑼 𐑡 :=
  (topos_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem topos_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
