...
noncomputable def multiagent_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def multiagent_true_arm : IGProtocol 𐑼 𐑡 :=
  (multiagent_protocol).restrictToEVALT
  --
-- false arm
noncomputable def multiagent_false_arm : IGProtocol 𐑼 𐑡 :=
  (multiagent_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem multiagent_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
