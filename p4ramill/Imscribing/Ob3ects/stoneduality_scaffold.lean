...
noncomputable def stoneduality_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def stoneduality_true_arm : IGProtocol 𐑼 𐑡 :=
  (stoneduality_protocol).restrictToEVALT
  --
-- false arm
noncomputable def stoneduality_false_arm : IGProtocol 𐑼 𐑡 :=
  (stoneduality_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem stoneduality_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
