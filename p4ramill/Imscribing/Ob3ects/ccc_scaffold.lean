...
noncomputable def ccc_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def ccc_true_arm : IGProtocol 𐑼 𐑡 :=
  (ccc_protocol).restrictToEVALT
  --
-- false arm
noncomputable def ccc_false_arm : IGProtocol 𐑼 𐑡 :=
  (ccc_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem ccc_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
