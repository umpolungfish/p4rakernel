...
noncomputable def adjoint_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def adjoint_true_arm : IGProtocol 𐑼 𐑡 :=
  (adjoint_protocol).restrictToEVALT
  --
-- false arm
noncomputable def adjoint_false_arm : IGProtocol 𐑼 𐑡 :=
  (adjoint_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem adjoint_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
