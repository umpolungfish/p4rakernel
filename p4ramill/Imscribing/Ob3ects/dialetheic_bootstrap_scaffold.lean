...
noncomputable def dialetheic_bootstrap_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def dialetheic_bootstrap_true_arm : IGProtocol 𐑼 𐑡 :=
  (dialetheic_bootstrap_protocol).restrictToEVALT
  --
-- false arm
noncomputable def dialetheic_bootstrap_false_arm : IGProtocol 𐑼 𐑡 :=
  (dialetheic_bootstrap_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem dialetheic_bootstrap_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
