...
noncomputable def htop_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def htop_true_arm : IGProtocol 𐑼 𐑡 :=
  (htop_protocol).restrictToEVALT
  --
-- false arm
noncomputable def htop_false_arm : IGProtocol 𐑼 𐑡 :=
  (htop_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem htop_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
