...
-- Class: imasm_self_imscription_ob3ect
...
noncomputable def imasm_self_imscription_ob3ect_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def imasm_self_imscription_ob3ect_true_arm : IGProtocol 𐑼 𐑡 :=
  (imasm_self_imscription_ob3ect_protocol).restrictToEVALT
  --
-- false arm
noncomputable def imasm_self_imscription_ob3ect_false_arm : IGProtocol 𐑼 𐑡 :=
  (imasm_self_imscription_ob3ect_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem imasm_self_imscription_ob3ect_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
