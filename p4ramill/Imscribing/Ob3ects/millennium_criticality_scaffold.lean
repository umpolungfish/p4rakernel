...
noncomputable def millennium_criticality_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def millennium_criticality_true_arm : IGProtocol 𐑼 𐑡 :=
  (millennium_criticality_protocol).restrictToEVALT
  --
-- false arm
noncomputable def millennium_criticality_false_arm : IGProtocol 𐑼 𐑡 :=
  (millennium_criticality_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem millennium_criticality_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
