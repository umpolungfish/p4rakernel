...
noncomputable def init_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def init_true_arm : IGProtocol 𐑼 𐑡 :=
  (init_protocol).restrictToEVALT
  --
-- false arm
noncomputable def init_false_arm : IGProtocol 𐑼 𐑡 :=
  (init_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem init_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
