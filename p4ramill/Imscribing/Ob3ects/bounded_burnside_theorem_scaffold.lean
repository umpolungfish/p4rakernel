...
-- ─────────────────────────────────────────────────────────────────────────────
-- Conventional-expression register (Class: Bounded Burnside Theorem)
--   Word: ⊢≻≺⋈⊣∈⊤⊥∋⊙⊞⊡⊙
-- ─────────────────────────────────────────────────────────────────────────────

def bounded_burnside_theorem_opcodes : List String := ["VINIT", "AFWD", "AREV", "CLINK", "TANCH", "FSPLIT", "EVALT", "EVALF", "FFUSE", "IMSCRIB", "ENGAGR", "IFIX", "IMSCRIB"]

def bounded_burnside_theorem_conventional_register : List ConventionalExpr :=
  conventionalRegisterOf bounded_burnside_theorem_opcodes

def bounded_burnside_theorem_glyph_word : String := glyphWordOf bounded_burnside_theorem_opcodes

/-- The register has exactly one entry per opcode. -/
theorem bounded_burnside_theorem_register_length : bounded_burnside_theorem_conventional_register.length = 13 := by
  native_decide

/-- The register's opcode column reproduces the glyph word exactly. -/
theorem bounded_burnside_theorem_register_matches_word : bounded_burnside_theorem_glyph_word = "⊢≻≺⋈⊣∈⊤⊥∋⊙⊞⊡⊙" := by
  native_decide

/-- The conventional protocol: a fixed-point walk over the ground imscription,
    each arrow annotated by its conventional expression. -/
def bounded_burnside_theorem_conventional_protocol : IGProtocol bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 :=
  .withGram Grammar.measure <|
  .withMem wool <|
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- VINIT
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- AFWD
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- AREV
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- CLINK
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- TANCH
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- FSPLIT
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- EVALT
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- EVALF
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- FFUSE
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- IMSCRIB
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- ENGAGR
  (.seq (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)  -- IFIX
  (.arrow bounded_burnside_theorem_s0 bounded_burnside_theorem_s0 bounded_burnside_theorem_s0)))))))))))))  -- IMSCRIB

/-- The conventional protocol carries all 13 arrows. -/
theorem bounded_burnside_theorem_conventional_protocol_depth : bounded_burnside_theorem_conventional_protocol.depth = 13 := by
  native_decide
