...
noncomputable def parashor_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def parashor_true_arm : IGProtocol 𐑼 𐑡 :=
  (parashor_protocol).restrictToEVALT
  --
-- false arm
noncomputable def parashor_false_arm : IGProtocol 𐑼 𐑡 :=
  (parashor_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem parashor_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
