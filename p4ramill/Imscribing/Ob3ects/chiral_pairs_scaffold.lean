...
noncomputable def chiral_pairs_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def chiral_pairs_true_arm : IGProtocol 𐑼 𐑡 :=
  (chiral_pairs_protocol).restrictToEVALT
  --
-- false arm
noncomputable def chiral_pairs_false_arm : IGProtocol 𐑼 𐑡 :=
  (chiral_pairs_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem chiral_pairs_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
