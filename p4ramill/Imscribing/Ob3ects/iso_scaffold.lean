...
noncomputable def iso_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def iso_true_arm : IGProtocol 𐑼 𐑡 :=
  (iso_protocol).restrictToEVALT
  --
-- false arm
noncomputable def iso_false_arm : IGProtocol 𐑼 𐑡 :=
  (iso_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem iso_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
