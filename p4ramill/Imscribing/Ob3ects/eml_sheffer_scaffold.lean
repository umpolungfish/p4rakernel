...
noncomputable def eml_sheffer_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def eml_sheffer_true_arm : IGProtocol 𐑼 𐑡 :=
  (eml_sheffer_protocol).restrictToEVALT
  --
-- false arm
noncomputable def eml_sheffer_false_arm : IGProtocol 𐑼 𐑡 :=
  (eml_sheffer_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem eml_sheffer_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
