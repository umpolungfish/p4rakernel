...
noncomputable def parakernel_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def parakernel_true_arm : IGProtocol 𐑼 𐑡 :=
  (parakernel_protocol).restrictToEVALT
  --
-- false arm
noncomputable def parakernel_false_arm : IGProtocol 𐑼 𐑡 :=
  (parakernel_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem parakernel_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
