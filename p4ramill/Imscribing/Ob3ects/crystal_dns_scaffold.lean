...
noncomputable def crystal_dns_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def crystal_dns_true_arm : IGProtocol 𐑼 𐑡 :=
  (crystal_dns_protocol).restrictToEVALT
  --
-- false arm
noncomputable def crystal_dns_false_arm : IGProtocol 𐑼 𐑡 :=
  (crystal_dns_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem crystal_dns_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
