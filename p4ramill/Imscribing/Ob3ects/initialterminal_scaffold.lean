...
noncomputable def initialterminal_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def initialterminal_true_arm : IGProtocol 𐑼 𐑡 :=
  (initialterminal_protocol).restrictToEVALT
  --
-- false arm
noncomputable def initialterminal_false_arm : IGProtocol 𐑼 𐑡 :=
  (initialterminal_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem initialterminal_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
