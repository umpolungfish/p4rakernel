...
noncomputable def sic_povm_parity_gate_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def sic_povm_parity_gate_true_arm : IGProtocol 𐑼 𐑡 :=
  (sic_povm_parity_gate_protocol).restrictToEVALT
  --
-- false arm
noncomputable def sic_povm_parity_gate_false_arm : IGProtocol 𐑼 𐑡 :=
  (sic_povm_parity_gate_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem sic_povm_parity_gate_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
