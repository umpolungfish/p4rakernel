...
noncomputable def portal_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def portal_true_arm : IGProtocol 𐑼 𐑡 :=
  (portal_protocol).restrictToEVALT
  --
-- false arm
noncomputable def portal_false_arm : IGProtocol 𐑼 𐑡 :=
  (portal_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem portal_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
