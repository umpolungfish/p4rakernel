...
noncomputable def imasm_parakernel_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def imasm_parakernel_true_arm : IGProtocol 𐑼 𐑡 :=
  (imasm_parakernel_protocol).restrictToEVALT
  --
-- false arm
noncomputable def imasm_parakernel_false_arm : IGProtocol 𐑼 𐑡 :=
  (imasm_parakernel_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem imasm_parakernel_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
