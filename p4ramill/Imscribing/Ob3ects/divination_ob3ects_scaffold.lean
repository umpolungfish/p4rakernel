...
noncomputable def divination_ob3ects_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def divination_ob3ects_true_arm : IGProtocol 𐑼 𐑡 :=
  (divination_ob3ects_protocol).restrictToEVALT
  --
-- false arm
noncomputable def divination_ob3ects_false_arm : IGProtocol 𐑼 𐑡 :=
  (divination_ob3ects_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem divination_ob3ects_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
