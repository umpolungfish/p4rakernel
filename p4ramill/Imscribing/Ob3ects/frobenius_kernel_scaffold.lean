...
noncomputable def frobenius_kernel_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def frobenius_kernel_true_arm : IGProtocol 𐑼 𐑡 :=
  (frobenius_kernel_protocol).restrictToEVALT
  --
-- false arm
noncomputable def frobenius_kernel_false_arm : IGProtocol 𐑼 𐑡 :=
  (frobenius_kernel_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem frobenius_kernel_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
