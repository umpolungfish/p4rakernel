...
noncomputable def daggercompact_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def daggercompact_true_arm : IGProtocol 𐑼 𐑡 :=
  (daggercompact_protocol).restrictToEVALT
  --
-- false arm
noncomputable def daggercompact_false_arm : IGProtocol 𐑼 𐑡 :=
  (daggercompact_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem daggercompact_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
