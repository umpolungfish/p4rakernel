...
noncomputable def void_genesis_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def void_genesis_true_arm : IGProtocol 𐑼 𐑡 :=
  (void_genesis_protocol).restrictToEVALT
  --
-- false arm
noncomputable def void_genesis_false_arm : IGProtocol 𐑼 𐑡 :=
  (void_genesis_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem void_genesis_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
