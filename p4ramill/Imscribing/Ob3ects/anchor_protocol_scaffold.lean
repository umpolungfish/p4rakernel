...
noncomputable def anchor_protocol_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def anchor_protocol_true_arm : IGProtocol 𐑼 𐑡 :=
  (anchor_protocol_protocol).restrictToEVALT
  --
-- false arm
noncomputable def anchor_protocol_false_arm : IGProtocol 𐑼 𐑡 :=
  (anchor_protocol_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem anchor_protocol_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
