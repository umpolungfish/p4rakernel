...
-- Class: elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp
...
noncomputable def elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp_true_arm : IGProtocol 𐑼 𐑡 :=
  (elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp_protocol).restrictToEVALT
  --
-- false arm
noncomputable def elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp_false_arm : IGProtocol 𐑼 𐑡 :=
  (elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem elder_futhark_rune_casting_24_runes_as_divinatory_system_fsp_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
