...
noncomputable def homotopytypetheory_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def homotopytypetheory_true_arm : IGProtocol 𐑼 𐑡 :=
  (homotopytypetheory_protocol).restrictToEVALT
  --
-- false arm
noncomputable def homotopytypetheory_false_arm : IGProtocol 𐑼 𐑡 :=
  (homotopytypetheory_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem homotopytypetheory_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
