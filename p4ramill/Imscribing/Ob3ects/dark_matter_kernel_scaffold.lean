...
noncomputable def dark_matter_kernel_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def dark_matter_kernel_true_arm : IGProtocol 𐑼 𐑡 :=
  (dark_matter_kernel_protocol).restrictToEVALT
  --
-- false arm
noncomputable def dark_matter_kernel_false_arm : IGProtocol 𐑼 𐑡 :=
  (dark_matter_kernel_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem dark_matter_kernel_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
