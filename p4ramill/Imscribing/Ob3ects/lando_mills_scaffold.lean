...
noncomputable def lando_mills_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def lando_mills_true_arm : IGProtocol 𐑼 𐑡 :=
  (lando_mills_protocol).restrictToEVALT
  --
-- false arm
noncomputable def lando_mills_false_arm : IGProtocol 𐑼 𐑡 :=
  (lando_mills_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem lando_mills_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
