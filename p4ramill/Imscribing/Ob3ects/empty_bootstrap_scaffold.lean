...
noncomputable def empty_bootstrap_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def empty_bootstrap_true_arm : IGProtocol 𐑼 𐑡 :=
  (empty_bootstrap_protocol).restrictToEVALT
  --
-- false arm
noncomputable def empty_bootstrap_false_arm : IGProtocol 𐑼 𐑡 :=
  (empty_bootstrap_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem empty_bootstrap_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
