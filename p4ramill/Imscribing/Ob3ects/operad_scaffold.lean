...
noncomputable def operad_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def operad_true_arm : IGProtocol 𐑼 𐑡 :=
  (operad_protocol).restrictToEVALT
  --
-- false arm
noncomputable def operad_false_arm : IGProtocol 𐑼 𐑡 :=
  (operad_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem operad_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
