...
noncomputable def euler_bricks_analysis_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def euler_bricks_analysis_true_arm : IGProtocol 𐑼 𐑡 :=
  (euler_bricks_analysis_protocol).restrictToEVALT
  --
-- false arm
noncomputable def euler_bricks_analysis_false_arm : IGProtocol 𐑼 𐑡 :=
  (euler_bricks_analysis_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem euler_bricks_analysis_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
