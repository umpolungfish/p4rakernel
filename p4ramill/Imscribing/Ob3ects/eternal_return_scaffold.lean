...
noncomputable def eternal_return_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def eternal_return_true_arm : IGProtocol 𐑼 𐑡 :=
  (eternal_return_protocol).restrictToEVALT
  --
-- false arm
noncomputable def eternal_return_false_arm : IGProtocol 𐑼 𐑡 :=
  (eternal_return_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem eternal_return_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
