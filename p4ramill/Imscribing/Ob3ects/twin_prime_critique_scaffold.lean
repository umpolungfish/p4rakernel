...
noncomputable def twin_prime_critique_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def twin_prime_critique_true_arm : IGProtocol 𐑼 𐑡 :=
  (twin_prime_critique_protocol).restrictToEVALT
  --
-- false arm
noncomputable def twin_prime_critique_false_arm : IGProtocol 𐑼 𐑡 :=
  (twin_prime_critique_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem twin_prime_critique_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
