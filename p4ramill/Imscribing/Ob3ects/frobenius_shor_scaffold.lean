...
noncomputable def frobenius_shor_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def frobenius_shor_true_arm : IGProtocol 𐑼 𐑡 :=
  (frobenius_shor_protocol).restrictToEVALT
  --
-- false arm
noncomputable def frobenius_shor_false_arm : IGProtocol 𐑼 𐑡 :=
  (frobenius_shor_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem frobenius_shor_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
