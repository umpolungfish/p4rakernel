...
noncomputable def scheduler_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def scheduler_true_arm : IGProtocol 𐑼 𐑡 :=
  (scheduler_protocol).restrictToEVALT
  --
-- false arm
noncomputable def scheduler_false_arm : IGProtocol 𐑼 𐑡 :=
  (scheduler_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem scheduler_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
