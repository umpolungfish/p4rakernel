...
noncomputable def iug_transmissibility_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def iug_transmissibility_true_arm : IGProtocol 𐑼 𐑡 :=
  (iug_transmissibility_protocol).restrictToEVALT
  --
-- false arm
noncomputable def iug_transmissibility_false_arm : IGProtocol 𐑼 𐑡 :=
  (iug_transmissibility_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem iug_transmissibility_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
