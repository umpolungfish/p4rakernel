...
noncomputable def dialetheic_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def dialetheic_true_arm : IGProtocol 𐑼 𐑡 :=
  (dialetheic_protocol).restrictToEVALT
  --
-- false arm
noncomputable def dialetheic_false_arm : IGProtocol 𐑼 𐑡 :=
  (dialetheic_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem dialetheic_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
