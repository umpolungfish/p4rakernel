...
noncomputable def truth_machine_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def truth_machine_true_arm : IGProtocol 𐑼 𐑡 :=
  (truth_machine_protocol).restrictToEVALT
  --
-- false arm
noncomputable def truth_machine_false_arm : IGProtocol 𐑼 𐑡 :=
  (truth_machine_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem truth_machine_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
