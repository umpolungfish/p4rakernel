...
noncomputable def quantum_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def quantum_true_arm : IGProtocol 𐑼 𐑡 :=
  (quantum_protocol).restrictToEVALT
  --
-- false arm
noncomputable def quantum_false_arm : IGProtocol 𐑼 𐑡 :=
  (quantum_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem quantum_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
