...
-- Class: topologically_protected_memory
...
noncomputable def topologically_protected_memory_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def topologically_protected_memory_true_arm : IGProtocol 𐑼 𐑡 :=
  (topologically_protected_memory_protocol).restrictToEVALT
  --
-- false arm
noncomputable def topologically_protected_memory_false_arm : IGProtocol 𐑼 𐑡 :=
  (topologically_protected_memory_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem topologically_protected_memory_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
