...
noncomputable def sm_ugt_consummation_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def sm_ugt_consummation_true_arm : IGProtocol 𐑼 𐑡 :=
  (sm_ugt_consummation_protocol).restrictToEVALT
  --
-- false arm
noncomputable def sm_ugt_consummation_false_arm : IGProtocol 𐑼 𐑡 :=
  (sm_ugt_consummation_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem sm_ugt_consummation_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
