...
noncomputable def linearlogic_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def linearlogic_true_arm : IGProtocol 𐑼 𐑡 :=
  (linearlogic_protocol).restrictToEVALT
  --
-- false arm
noncomputable def linearlogic_false_arm : IGProtocol 𐑼 𐑡 :=
  (linearlogic_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem linearlogic_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
