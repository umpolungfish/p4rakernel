...
noncomputable def galois_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def galois_true_arm : IGProtocol 𐑼 𐑡 :=
  (galois_protocol).restrictToEVALT
  --
-- false arm
noncomputable def galois_false_arm : IGProtocol 𐑼 𐑡 :=
  (galois_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem galois_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
