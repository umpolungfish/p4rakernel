...
noncomputable def belnap_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def belnap_true_arm : IGProtocol 𐑼 𐑡 :=
  (belnap_protocol).restrictToEVALT
  --
-- false arm
noncomputable def belnap_false_arm : IGProtocol 𐑼 𐑡 :=
  (belnap_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem belnap_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
