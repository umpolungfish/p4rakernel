...
noncomputable def linear_chain_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def linear_chain_true_arm : IGProtocol 𐑼 𐑡 :=
  (linear_chain_protocol).restrictToEVALT
  --
-- false arm
noncomputable def linear_chain_false_arm : IGProtocol 𐑼 𐑡 :=
  (linear_chain_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem linear_chain_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
