...
noncomputable def yoneda_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def yoneda_true_arm : IGProtocol 𐑼 𐑡 :=
  (yoneda_protocol).restrictToEVALT
  --
-- false arm
noncomputable def yoneda_false_arm : IGProtocol 𐑼 𐑡 :=
  (yoneda_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem yoneda_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
