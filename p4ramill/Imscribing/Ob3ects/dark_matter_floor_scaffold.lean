...
noncomputable def dark_matter_floor_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def dark_matter_floor_true_arm : IGProtocol 𐑼 𐑡 :=
  (dark_matter_floor_protocol).restrictToEVALT
  --
-- false arm
noncomputable def dark_matter_floor_false_arm : IGProtocol 𐑼 𐑡 :=
  (dark_matter_floor_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem dark_matter_floor_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
