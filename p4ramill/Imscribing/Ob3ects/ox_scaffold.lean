...
noncomputable def ox_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def ox_true_arm : IGProtocol 𐑼 𐑡 :=
  (ox_protocol).restrictToEVALT
  --
-- false arm
noncomputable def ox_false_arm : IGProtocol 𐑼 𐑡 :=
  (ox_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem ox_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
