...
noncomputable def kanextension_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def kanextension_true_arm : IGProtocol 𐑼 𐑡 :=
  (kanextension_protocol).restrictToEVALT
  --
-- false arm
noncomputable def kanextension_false_arm : IGProtocol 𐑼 𐑡 :=
  (kanextension_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem kanextension_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
