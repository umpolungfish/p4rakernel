...
noncomputable def hopf_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def hopf_true_arm : IGProtocol 𐑼 𐑡 :=
  (hopf_protocol).restrictToEVALT
  --
-- false arm
noncomputable def hopf_false_arm : IGProtocol 𐑼 𐑡 :=
  (hopf_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem hopf_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
