...
noncomputable def imscriptionoperatingsystem_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def imscriptionoperatingsystem_true_arm : IGProtocol 𐑼 𐑡 :=
  (imscriptionoperatingsystem_protocol).restrictToEVALT
  --
-- false arm
noncomputable def imscriptionoperatingsystem_false_arm : IGProtocol 𐑼 𐑡 :=
  (imscriptionoperatingsystem_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem imscriptionoperatingsystem_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
