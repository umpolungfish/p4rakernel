...
noncomputable def collatz_proof_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def collatz_proof_true_arm : IGProtocol 𐑼 𐑡 :=
  (collatz_proof_protocol).restrictToEVALT
  --
-- false arm
noncomputable def collatz_proof_false_arm : IGProtocol 𐑼 𐑡 :=
  (collatz_proof_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem collatz_proof_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
