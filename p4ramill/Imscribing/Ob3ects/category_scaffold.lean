...
noncomputable def category_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def category_true_arm : IGProtocol 𐑼 𐑡 :=
  (category_protocol).restrictToEVALT
  --
-- false arm
noncomputable def category_false_arm : IGProtocol 𐑼 𐑡 :=
  (category_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem category_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
