...
noncomputable def shutdown_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def shutdown_true_arm : IGProtocol 𐑼 𐑡 :=
  (shutdown_protocol).restrictToEVALT
  --
-- false arm
noncomputable def shutdown_false_arm : IGProtocol 𐑼 𐑡 :=
  (shutdown_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem shutdown_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
