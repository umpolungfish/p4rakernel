...
noncomputable def test_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def test_true_arm : IGProtocol 𐑼 𐑡 :=
  (test_protocol).restrictToEVALT
  --
-- false arm
noncomputable def test_false_arm : IGProtocol 𐑼 𐑡 :=
  (test_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem test_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
