...
noncomputable def perfect_cuboid_proof_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def perfect_cuboid_proof_true_arm : IGProtocol 𐑼 𐑡 :=
  (perfect_cuboid_proof_protocol).restrictToEVALT
  --
-- false arm
noncomputable def perfect_cuboid_proof_false_arm : IGProtocol 𐑼 𐑡 :=
  (perfect_cuboid_proof_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem perfect_cuboid_proof_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
