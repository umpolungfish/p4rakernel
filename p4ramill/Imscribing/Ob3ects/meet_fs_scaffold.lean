...
noncomputable def meet_fs_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def meet_fs_true_arm : IGProtocol 𐑼 𐑡 :=
  (meet_fs_protocol).restrictToEVALT
  --
-- false arm
noncomputable def meet_fs_false_arm : IGProtocol 𐑼 𐑡 :=
  (meet_fs_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem meet_fs_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
