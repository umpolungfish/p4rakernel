...
noncomputable def presheaf_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def presheaf_true_arm : IGProtocol 𐑼 𐑡 :=
  (presheaf_protocol).restrictToEVALT
  --
-- false arm
noncomputable def presheaf_false_arm : IGProtocol 𐑼 𐑡 :=
  (presheaf_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem presheaf_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
