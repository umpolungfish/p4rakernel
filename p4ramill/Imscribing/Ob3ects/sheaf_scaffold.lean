...
noncomputable def sheaf_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def sheaf_true_arm : IGProtocol 𐑼 𐑡 :=
  (sheaf_protocol).restrictToEVALT
  --
-- false arm
noncomputable def sheaf_false_arm : IGProtocol 𐑼 𐑡 :=
  (sheaf_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem sheaf_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
