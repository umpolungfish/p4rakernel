...
noncomputable def ivm_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def ivm_true_arm : IGProtocol 𐑼 𐑡 :=
  (ivm_protocol).restrictToEVALT
  --
-- false arm
noncomputable def ivm_false_arm : IGProtocol 𐑼 𐑡 :=
  (ivm_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem ivm_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
