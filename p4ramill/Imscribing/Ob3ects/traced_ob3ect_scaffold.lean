...
noncomputable def traced_ob3ect_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def traced_ob3ect_true_arm : IGProtocol 𐑼 𐑡 :=
  (traced_ob3ect_protocol).restrictToEVALT
  --
-- false arm
noncomputable def traced_ob3ect_false_arm : IGProtocol 𐑼 𐑡 :=
  (traced_ob3ect_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem traced_ob3ect_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
