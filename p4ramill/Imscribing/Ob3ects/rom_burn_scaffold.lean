...
noncomputable def rom_burn_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def rom_burn_true_arm : IGProtocol 𐑼 𐑡 :=
  (rom_burn_protocol).restrictToEVALT
  --
-- false arm
noncomputable def rom_burn_false_arm : IGProtocol 𐑼 𐑡 :=
  (rom_burn_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem rom_burn_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
