...
noncomputable def docs_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def docs_true_arm : IGProtocol 𐑼 𐑡 :=
  (docs_protocol).restrictToEVALT
  --
-- false arm
noncomputable def docs_false_arm : IGProtocol 𐑼 𐑡 :=
  (docs_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem docs_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
