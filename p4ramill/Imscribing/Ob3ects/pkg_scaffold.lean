...
noncomputable def pkg_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def pkg_true_arm : IGProtocol 𐑼 𐑡 :=
  (pkg_protocol).restrictToEVALT
  --
-- false arm
noncomputable def pkg_false_arm : IGProtocol 𐑼 𐑡 :=
  (pkg_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem pkg_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
