...
noncomputable def paradoxd_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def paradoxd_true_arm : IGProtocol 𐑼 𐑡 :=
  (paradoxd_protocol).restrictToEVALT
  --
-- false arm
noncomputable def paradoxd_false_arm : IGProtocol 𐑼 𐑡 :=
  (paradoxd_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem paradoxd_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
