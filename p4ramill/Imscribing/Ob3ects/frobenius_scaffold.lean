...
noncomputable def frobenius_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def frobenius_true_arm : IGProtocol 𐑼 𐑡 :=
  (frobenius_protocol).restrictToEVALT
  --
-- false arm
noncomputable def frobenius_false_arm : IGProtocol 𐑼 𐑡 :=
  (frobenius_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem frobenius_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
