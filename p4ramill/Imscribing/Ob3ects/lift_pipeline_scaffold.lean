...
noncomputable def lift_pipeline_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def lift_pipeline_true_arm : IGProtocol 𐑼 𐑡 :=
  (lift_pipeline_protocol).restrictToEVALT
  --
-- false arm
noncomputable def lift_pipeline_false_arm : IGProtocol 𐑼 𐑡 :=
  (lift_pipeline_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem lift_pipeline_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
