...
noncomputable def dual_bootstrap_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def dual_bootstrap_true_arm : IGProtocol 𐑼 𐑡 :=
  (dual_bootstrap_protocol).restrictToEVALT
  --
-- false arm
noncomputable def dual_bootstrap_false_arm : IGProtocol 𐑼 𐑡 :=
  (dual_bootstrap_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem dual_bootstrap_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
