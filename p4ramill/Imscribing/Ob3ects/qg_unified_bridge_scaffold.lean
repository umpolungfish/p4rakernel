...
noncomputable def qg_unified_bridge_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def qg_unified_bridge_true_arm : IGProtocol 𐑼 𐑡 :=
  (qg_unified_bridge_protocol).restrictToEVALT
  --
-- false arm
noncomputable def qg_unified_bridge_false_arm : IGProtocol 𐑼 𐑡 :=
  (qg_unified_bridge_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem qg_unified_bridge_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
