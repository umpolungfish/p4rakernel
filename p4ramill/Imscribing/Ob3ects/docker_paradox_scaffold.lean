...
noncomputable def docker_paradox_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def docker_paradox_true_arm : IGProtocol 𐑼 𐑡 :=
  (docker_paradox_protocol).restrictToEVALT
  --
-- false arm
noncomputable def docker_paradox_false_arm : IGProtocol 𐑼 𐑡 :=
  (docker_paradox_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem docker_paradox_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
