...
noncomputable def proofbridge_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def proofbridge_true_arm : IGProtocol 𐑼 𐑡 :=
  (proofbridge_protocol).restrictToEVALT
  --
-- false arm
noncomputable def proofbridge_false_arm : IGProtocol 𐑼 𐑡 :=
  (proofbridge_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem proofbridge_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
