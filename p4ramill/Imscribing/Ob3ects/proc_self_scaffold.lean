...
noncomputable def proc_self_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def proc_self_true_arm : IGProtocol 𐑼 𐑡 :=
  (proc_self_protocol).restrictToEVALT
  --
-- false arm
noncomputable def proc_self_false_arm : IGProtocol 𐑼 𐑡 :=
  (proc_self_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem proc_self_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
