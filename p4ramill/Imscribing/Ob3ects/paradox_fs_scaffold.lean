...
noncomputable def paradox_fs_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def paradox_fs_true_arm : IGProtocol 𐑼 𐑡 :=
  (paradox_fs_protocol).restrictToEVALT
  --
-- false arm
noncomputable def paradox_fs_false_arm : IGProtocol 𐑼 𐑡 :=
  (paradox_fs_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem paradox_fs_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
