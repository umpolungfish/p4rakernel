...
-- Class: kabbalistic_tree_of_life_10_sephirot_and_22_paths
...
noncomputable def kabbalistic_tree_of_life_10_sephirot_and_22_paths_protocol : IGProtocol 𐑼 𐑡 :=
  .withGram 𐑠 <|
...
-- truth arm
noncomputable def kabbalistic_tree_of_life_10_sephirot_and_22_paths_true_arm : IGProtocol 𐑼 𐑡 :=
  (kabbalistic_tree_of_life_10_sephirot_and_22_paths_protocol).restrictToEVALT
  --
-- false arm
noncomputable def kabbalistic_tree_of_life_10_sephirot_and_22_paths_false_arm : IGProtocol 𐑼 𐑡 :=
  (kabbalistic_tree_of_life_10_sephirot_and_22_paths_protocol).restrictToEVALF
  --
-- ── Verification theorems ───────────────────────────────────────────────────

theorem kabbalistic_tree_of_life_10_sephirot_and_22_paths_tier : TierFunctor.obj 𐑼 = .O₂ := by decide
