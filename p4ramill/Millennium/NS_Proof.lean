...
/-- NS source structural type: O_2† (Phi_c + D_infty + Omega_Z). -/
theorem ns_source_tier : imscriptionTier navierStokesSource = .O_2dag := by
...
/-- NS Global Regularity (the Clay Millennium Problem).
    The structural proof reduces this to the trapping lemma.
