...
/-!
Sweep: lift every theorem THIS repo declares and emit `name<TAB>word` for Vox to
verdict in bulk. Mathlib's own declarations are excluded — the question is what
this corpus proves, not what it imports.
-/
open Lean Meta Elab
    ...
    if ours nm then
      ...
      | .thmInfo ti =>
          ...
          if w != "" then
            ...
            k := k + 1
      | _ => pure ()
  IO.eprintln s!"lifted {k} theorems"
