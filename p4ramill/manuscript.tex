...
Section~2 describes the Imscribing Grammar and the crystal of types.
...
observed---by 12 primitives that jointly determine its position
...
Frobenius identity, and the same type as the kernel that contains it.
