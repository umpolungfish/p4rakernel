...
structure Environment where
  ...
  quotInit    : Bool := false
  /--
  When `paraconsistent = true`, the kernel operates in paraconsistent mode:
  the principle of explosion (False.elim) is NOT automatically generated
  for empty inductive predicates. Contradictions can be held without
  trivializing the type system. This enables dialetheic reasoning where
  both a proposition and its negation can be true without everything
  becoming provable.
  -/
...
@[export lean_environment_mark_paraconsistent]
